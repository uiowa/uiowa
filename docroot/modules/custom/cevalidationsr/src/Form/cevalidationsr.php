...
class cevalidationsr extends FormBase
{
	...
	{
		//This is the only way to get Bootstrap included without having to resort to forcing clients to install and use a custom THEME!!!!
		//Note that only the CSS file is needed here. The javascript CDN file is included with jQuery in the cevalidationsr.libraries.yml file
		...
		$form['credentialId'] = [
			'#type' => 'textfield',
			'#title' => $this->t('Please enter CeDiD<br />not case sensitive:'),
			'#label_attributes' => ['class' => ['labelgray']],
			'#required' => true,
			'#attributes' => array(
				'class' => array('CeDiDNumber', 'text-box', 'single-line'),
				'data-masked-input' => array("wwww-wwww-wwww"),
				'data-mask' => array("AAAA-AAAA-AAAA"),
				'data-val' => array("true"),
				'data-val-regex' => array("____-____-____ format required."),
				'data-val-regex-pattern' => array("(([a-zA-Z0-9]{4})[-]([a-zA-Z0-9]{4})[-]([a-zA-Z0-9]{4}))"),
				'data-val-required' => array("The CeDiD field is required."),
				'placeholder' => array("____-____-____")
			),
			'#maxlength' => 14,
			'#size' => 14,
			'#input_mask'=>'****-****-****',
		...
		$form['actions'] = array(
			...
			'#ajax' => array(
				'callback' => '::setMessage', //'Drupal\modules\custom\cevalidationsr\cevalidationsrConnection::queryEndpoint',
		...
		$form['cecredentialtrustlogo'] = array(
			'#type' => 'markup',
	...
	public function setMessage(array &$form, FormStateInterface $form_state)
	{
		...
		// }
			...
			$response->addCommand(new InvokeCommand('#divValidationResult', 'removeClass', array('hidden')));
