 ...
 *
 * @Condition(
 *   id = "layout_builder_enabled",
 *   label = @Translation("Layout Builder Enabled"),
 *   context_definitions = {
 *     "node" = @ContextDefinition("entity:node", label = @Translation("Node"))
 *   }
 * )
 */
class LayoutBuilderEnabled extends ConditionPluginBase implements ContainerFactoryPluginInterface {
