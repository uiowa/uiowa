...
/**
 * Provides media type plugin for Concept3D static map.
 *
 * @MediaSource(
 *   id = "concept3d_static_map",
 *   label = @Translation("Concept3D static map"),
 *   description = @Translation("Static Concept3D map"),
 *   allowed_field_types = {"string", "string_long", "link"},
 *   forms = {
 *     "media_library_add" = "Drupal\sitenow_media_wysiwyg\Form\Concept3DStaticMapForm",
 *   },
 *
 * )
 */
class Concept3DStaticMap extends MediaSourceBase implements MediaSourceFieldConstraintsInterface {
  ...
  public function createSourceField(MediaTypeInterface $type) {
    return parent::createSourceField($type)->set('label', 'Location ID');
  }
      ...
      case 'thumbnail_uri':
        try {
          $response = $this->client->get(
            self::BASE_URL . "/map/static-map/?map=1890&loc={$id}&scale=2&label&zoom=17",
            [
              'allow_redirects' => [
          ...
          $destination = $scheme . 'concept3D_thumbnails/';
