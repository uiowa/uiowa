...
class Directory {
  /**
   * The Directory Profiles settings config.
   *
  ...
  /**
   * The Directory Profiles environment.
   *
   * @var string
   */
  ...
  /**
   * The Directory Profiles API endpoint.
   *
   * @var string
   */
  protected $endpoint;
  ...
  /**
   * Constructs an Directory Profiles service object.
   *
