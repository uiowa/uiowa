 ...
 */
function collegiate_install_tasks() {
  $tasks = [];

  $tasks['collegiate_prepare_administrator'] = [];
  $tasks['collegiate_set_front_page'] = [];
  $tasks['collegiate_disallow_free_registration'] = [];
  $tasks['collegiate_grant_shortcut_access'] = [];
  $tasks['collegiate_set_default_theme'] = [];
  $tasks['collegiate_set_logo'] = [];
  $tasks['collegiate_alter_frontpage_view'] = [];
 ...
 */
function collegiate_prepare_administrator() {
 ...
 */
function collegiate_set_front_page() {
 ...
 */
function collegiate_disallow_free_registration() {
  Drupal::configFactory()
 ...
 */
function collegiate_grant_shortcut_access() {
 ...
 */
function collegiate_set_default_theme() {
  Drupal::configFactory()
 ...
 */
function collegiate_set_logo() {
  $collegiate_path = drupal_get_path('profile', 'collegiate');

  // todo: Set no logo as the default

//  Drupal::configFactory()
//    ->getEditable('system.theme.global')
//    ->set('logo', [
//      'path' => $collegiate_path . '/lightning.png',
//      'url' => '',
//      'use_default' => FALSE,
//    ])
//    ->set('favicon', [
//      'mimetype' => 'image/vnd.microsoft.icon',
//      'path' => $collegiate_path . '/favicon.ico',
//      'url' => '',
//      'use_default' => FALSE,
//    ])
//    ->save(TRUE);
 ...
 */
function collegiate_alter_frontpage_view() {
 ...
 */
function collegiate_user_role_presave(RoleInterface $role) {
