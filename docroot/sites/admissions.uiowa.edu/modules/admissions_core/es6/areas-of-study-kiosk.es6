      ...
      $('.view-id-areas_of_study_kiosk', context).once('aos_kiosk').each(function (index) {
        document.addEventListener('click', function (event) {
          ...
          if (event.target.matches('#kiosk-print-button')) {
            ...
            printJS({printable:'/print/view/pdf/areas_of_study_kiosk/filtered_print_page?view_args[0]=' + print_node_ids, type:'pdf', showModal:true, onPrintDialogClose: dialogClose});
          }
