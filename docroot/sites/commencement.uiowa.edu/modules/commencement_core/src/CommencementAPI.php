...
/**
 * Commencement API service.
 */
class CommencementAPI {

  const BASE_URL_1 = 'https://content.uiowa.edu/api/v1/views/events_api.json?display_id=events&filters[enddate][value][date]=01-01-2100&filters[types]=355&filters[department]=7266&items_per_page=100';

  /**
   * The commencement_core logger channel.
   *
  ...
  /**
   * Make a Commencement API request and return data.
   *
   * @param string $method
  ...
  public function request($method, $path, array $params = [], array $options = [], $base = self::BASE_URL_1) {
    ...
    $cid = "commencement_core:request:{$hash}";
