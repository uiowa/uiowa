 ...
 * local.settings.php file, so that that file may override any variable set up
 * the chain. Taken in total, the points at which files are included into the
 * base settings.php file are...
 *
 * settings.php
 *   |
