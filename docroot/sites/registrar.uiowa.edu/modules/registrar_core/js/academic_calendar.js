  ...
  class AcademicCalendar {
    ...
    filterAndDisplayEvents() {
      ...
      const filteredEvents = this.allEvents.filter(event => {
        ...
        const matchesPreviousEvents = this.showPreviousEvents || eventDate >= today;
        ...
        return matchesSearch && matchesMonth && matchesSession && matchesSubSession && matchesPreviousEvents && matchesCategories;
      });

      // @todo Implement this.
      this.displayEvents(filteredEvents);

      if (this.calendarContent) {(function (Drupal, drupalSettings) {
        'use strict';
